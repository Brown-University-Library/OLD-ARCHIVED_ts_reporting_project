...
class DateMaker(object):
    ...
    def get_acc_months( self, scheme, host ):
        ...
        for date_obj in acc_months:
            ...
            link = '{url}{yr}/{mo}/'.format( sch=scheme, hst=host, url=reverse('accessions'), yr=date_obj.year, mo=date_obj.month )
    ...
    def get_cat_months( self, scheme, host ):
        ...
        for date_obj in cat_months:
            ...
            link = '{url}{yr}/{mo}/'.format( sch=scheme, hst=host, url=reverse('cataloging'), yr=date_obj.year, mo=date_obj.month )
    ...
    def get_acc_years( self, scheme, host ):
        ...
        for date_obj in acc_years:
            ...
            link = '{url}{yr}/'.format( sch=scheme, hst=host, url=reverse('accessions'), yr=date_obj.year )
    ...
    def get_cat_years( self, scheme, host ):
        ...
        for date_obj in cat_years:
            ...
            link = '{url}{yr}/'.format( sch=scheme, hst=host, url=reverse('cataloging'), yr=date_obj.year )
